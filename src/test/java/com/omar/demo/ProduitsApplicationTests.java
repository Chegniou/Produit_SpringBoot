...
import com.omar.demo.repos.ProduitRepository;
...
{
List<Produit> prods = produitRepository.findByNomProduit("redmi 10");
for (Produit p : prods)
{
System.out.println(p);
}
...
{
List<Produit> prods = produitRepository.findByNomPrix("PC Asus", 2800.0);
for (Produit p : prods)
{
System.out.println(p);
}
